import 'package:first_app/agriculture/view/agriculture_kind.dart';
...
import '../controller/agriculture_controller.dart';

// ignore: must_be_immutable
class AgriculturePageView extends GetResponsiveView<AgricultureController> {
  AgricultureController controller = Get.put(AgricultureController());
  @override
  ...
  return Padding(
      ...
      child: Tooltip(
        ...
        child: InkWell(
          onTap: () {
            c.full();
            Get.to(AgricultureShowPageView());
          },
          child: Container(
